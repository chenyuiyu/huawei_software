...
// * @description 初始化数据结构
// **/
// public static void initStructure(List<PlatForm> platformsList, List<Robot>
// robotsList) {
...
// **/
// public static boolean readMapOK(Scanner inStream, List<Robot> robotsList,
...
// continue;
// }
// if (c == 'A') robotsList.add(new Robot(rnum++, col * 0.5 + 0.25, 50.0 - row *
// 0.50 + 0.25));
// else
// platformsList.add(new PlatForm(PLAYFORM_NUMBER++, (int) (c - '0'), col * 0.5
// + 0.25, 50.0 - row * 0.50 + 0.25));
// col++;
// }
// row++;
// col = 0;
...
// **/
// public static boolean readFrameOK(Scanner inStream, List<PlatForm>
// platformsList, List<Robot> robotsList) {
// String line;
// int ridx = 0, pidx = 0;
// while (inStream.hasNextLine()) {
// line = inStream.nextLine();
...
// curR.setItem(new Item(Double.parseDouble(msg[2]), Double.parseDouble(msg[3]),
// value));
// }
// }
// curR.setAngleSpeed(Double.parseDouble(msg[4])); // 设置角速度
// curR.setLineSpeed(Double.parseDouble(msg[5]), Double.parseDouble(msg[6])); //
// 设置线速度
// curR.setDirction(Double.parseDouble(msg[7])); // 更新朝向
// curR.setPosition(Double.parseDouble(msg[8]), Double.parseDouble(msg[9])); //
// 更新位置坐标
// }
...
// public static List<Order> findTargetForRobot(List<PlatForm> platformsList,
...
// double costa = coefficientDistance * Utils.getDistance(a.getPosition(),
// curR.getPosition());
// costa += (costa > a.getLeftFrame() ? 0 : a.getLeftFrame() - costa);
// double costb = coefficientDistance * Utils.getDistance(b.getPosition(),
// curR.getPosition());
